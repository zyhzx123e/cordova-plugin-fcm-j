...
//    }
    ...
    NSLog(@"didReceiveRemoteNotification Message ID: %@", userInfo[@"gcm.message_id"]);
...
//    }
    ...
    // Print message ID.
    NSLog(@"fetchCompletionHandler Message ID: %@", userInfo[@"gcm.message_id"]);
    ...
    if (application.applicationState == UIApplicationStateActive
        ...
        NSLog(@"fetchCompletionHandler app in background");
